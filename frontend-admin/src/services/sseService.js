...
export class SSEService {
  ...
  connect(storeId) {
    ...
    this.disconnect()
    this.eventSource = new EventSource(`${baseUrl}/stores/${storeId}/events/admin?token=${token}`)
    ...
    this.eventSource.onerror = () => {
      ...
      if (this.retryCount < MAX_RETRIES) { this.retryCount++; setTimeout(() => this.connect(storeId), RETRY_DELAY) }
